...
export function ProModeSelector() {
  ...
  const hasAnyKey = settings ? hasAnyProviderKey(settings) : false;
  // BYOK users with any provider can toggle pro features
  const proModeTogglable =
    (hasProKey || hasAnyKey) && Boolean(settings?.enableDyadPro);
  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure advanced features</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          ...
          {!hasProKey && !hasAnyKey && (
            <div className="text-sm text-center text-muted-foreground">
              <span className="text-muted-foreground">
                Configure a provider in Settings to enable features
              </span>
            </div>
          )}
          <div className="flex flex-col gap-3">
            <SelectorRow
              ...
              tooltip="Enables advanced features like web search, code exploration, and image generation."
              isTogglable={hasProKey || hasAnyKey}
