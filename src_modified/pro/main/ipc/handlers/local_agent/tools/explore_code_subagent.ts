...
function assertDyadValueAvailable(_settings: UserSettings): void {
  // Users with any configured provider can use explore_code sub-agent
  // No assertion needed - any configured provider works
}
