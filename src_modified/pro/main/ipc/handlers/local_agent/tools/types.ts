...
export interface AgentContext {
  ...
  /**
   * If true, the user has the engine API configured.
   * Engine-dependent tools use this to access enhanced features.
   */
  isDyadPro: boolean;
  /**
   * If true, this turn is using a free model. Some enhanced
