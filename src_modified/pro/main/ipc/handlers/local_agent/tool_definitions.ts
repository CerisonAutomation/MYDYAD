...
export const TOOL_DEFINITIONS: readonly ToolDefinition[] = [
  ...
  localTranscribeTool,
  hotspotsTool,
  // Code quality analysis tools (from repo-intel)
  codeSmellsTool,
  deadCodeTool,
  securityScanTool,
  complexityTool,
  ...
  depAuditTool,
  contextOptimizeTool,
  // Additional analysis tools (inspired by Lovable MCP)
  perfAuditTool,
  architectureMapTool,
  repoPulseTool,
  licenseCheckTool,
  ...
  semgrepScanTool,
  codeqlScanTool,
  // Game-changing tools (AI-powered automation)
  autoRefactorTool,
  ...
  githubIssuesTool,
  githubPrsTool,
  // Auto Zenith (autofable) and Code Research
  autoZenithTool,
  codeResearchTool,
  // Latest high-value tools (2025-2026)
  tokenCompressorTool,
  aiSecurityAuditTool,
  codeReviewBotTool,
  codeContextGraphTool,
  // 17 Gamechanging Visual Tools
  visualBugDetectorTool,
  accessibilityAuditorTool,
  responsiveCheckerTool,
  ...
  errorVisualizerTool,
  importAnalyzerTool,
  componentPlaygroundTool,
  smartFixTool,
  visualTestTool,
  regressionDetectorTool,
  colorContrastTool,
  cssAnalyzerTool,
  autoQualityTool,
];
