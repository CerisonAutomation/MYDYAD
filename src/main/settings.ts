...
// Module-level cache for readSettings() to avoid repeated synchronous
// fs.readFileSync + JSON.parse + Zod validation on every call.
...
export function readSettings(): UserSettings {
  ...
  try {
    ...
    const settings = readExistingSettingsFile(filePath).settings;
