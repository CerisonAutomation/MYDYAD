...
export function Agent2ModeSelector() {
  ...
  const agent2ModeTogglable = hasProKey && Boolean(settings?.enableDyadPro);
    ...
    <Popover>
      <Tooltip>
        ...
        >
          ...
          <span className="font-medium">Agent2</span>
        </TooltipTrigger>
        <TooltipContent>Configure Agent2 settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              ...
              <span className="text-primary font-medium">Agent2 Mode</span>
            </h4>
          ...
          <div className="flex flex-col gap-3">
            <SelectorRow
              id="agent2-enabled"
              label="Enable Agent2"
              tooltip="Activates Agent2 features: web access, turbo edits, and smart context."
              isTogglable={hasProKey}
              settingEnabled={Boolean(settings?.enableDyadPro)}
              toggle={toggleAgent2Enabled}
            />
            <Accordion>
              <AccordionItem
                ...
                <AccordionContent className="pb-3">
                  <div className="flex flex-col gap-5 pt-2">
                    <SelectorRow
                      id="web-search"
                      label="Web Access"
                      tooltip="Allows Agent2 to access the web (e.g. search for information)"
                      isTogglable={agent2ModeTogglable}
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-1.5">
        ...
        <span title="Selects the most relevant files as context to save tokens working on large codebases.">
          <Info
            className={`h-4 w-4 cursor-help ${!isTogglable ? "text-muted-foreground/50" : "text-muted-foreground"}`}
          />
        </span>
      ...
      >
        ...
        <Tooltip>
          ...
          <TooltipContent>
            Keeps full conversation history for maximum context
          </TooltipContent>
        </Tooltip>
      </div>
    </div>
