...
export function ChatModeSelector() {
  ...
  const isAgent2Enabled = settings ? checkAgent2Enabled(settings) : false;
  ...
  useEffect(() => {
    ...
    showChatModeFallbackToast({
      effectiveMode,
      isPro: isAgent2Enabled,
      toastId: toastKey,
    });
  }, [chatId, effectiveMode, fallbackReason, isAgent2Enabled, storedChatMode]);
  ...
  const getModeDisplayName = (mode: ChatMode) => {
    return getChatModeDisplayName(mode, isAgent2Enabled);
  };
