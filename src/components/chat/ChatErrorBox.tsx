...
export function ChatErrorBox({
  ...
  if (error.includes("doesn't have a free quota tier")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        <span className="ml-1">
          <ExternalLink
            href="https://dyad.sh/docs/help/ai-provider-setup"
            variant="primary"
          >
  ...
  //
  // Sometimes Agent2 can return rate limit errors and we do not want to
  // show the upgrade to Agent2 link in that case because they are
  // already on the Agent2 plan.
  if (
    !isAgent2Enabled &&
  ...
  if (error.includes("LiteLLM Virtual Key expected")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          Looks like you don't have a valid API key.{" "}
          <ExternalLink
            href="https://dyad.sh/docs/help/ai-provider-setup"
            variant="primary"
          >
  ...
  if (isAgent2Enabled && error.includes("ExceededBudget:")) {
    return (
      <ChatInfoContainer onDismiss={onDismiss}>
        <span>
          You have reached your API rate limit.{" "}
          {!isTrialProUser && (
            <>
  ...
  if (error.includes("FREE_AGENT_QUOTA_EXCEEDED")) {
    return (
      <ChatErrorContainer onDismiss={onDismiss}>
        ...
        switch to a different model or configure your API key in Settings.
        <div className="mt-2 space-y-2 space-x-2">
          <ExternalLink
            href="https://dyad.sh/docs/help/ai-provider-setup"
            variant="primary"
  ...
  return (
    <ChatErrorContainer onDismiss={onDismiss}>
      ...
      <div className="mt-2 space-y-2 space-x-2">
        ...
        {isAgent2Enabled && onStartNewChat && (
          <Tooltip>
            <TooltipTrigger
...
function ExternalLink({
  ...
  return (
    <a
      ...
      onClick={() => ipc.instructions.openExternalUrl(href)}
    >
      <span>{children}</span>
      {iconElement}
    </a>
                ...
                a: ({ children: linkChildren, ...props }) => (
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      if (props.href) {
                        ipc.instructions.openExternalUrl(props.href);
                      }
                    }}
