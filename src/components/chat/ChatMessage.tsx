...
const ChatMessage = memo(
  ({ message, isLastMessage, isCancelledPrompt }: ChatMessageProps) => {
    ...
    // Extract tool call summary from assistant message content
    const toolCallSummary = useMemo(() => {
      if (message.role !== "assistant") return null;
      return extractToolCallSummary(message.content);
