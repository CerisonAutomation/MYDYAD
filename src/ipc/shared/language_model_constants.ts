  ...
  opencode: [
    {
      ...
      description: "DeepSeek's most capable model for complex reasoning",
      maxOutputTokens: 128_000,
      contextWindow: 131_072,
      temperature: 1.0,
      dollarSigns: 1,
    ...
    },
    {
      ...
      description: "Alibaba's latest flagship model",
      maxOutputTokens: 128_000,
      contextWindow: 131_072,
      temperature: 1.0,
      dollarSigns: 1,
    },
    {
      ...
      description: "High-performance model for coding and analysis",
      maxOutputTokens: 128_000,
      contextWindow: 131_072,
      temperature: 1.0,
      dollarSigns: 1,
    ...
    },
    {
      name: "glm-5.2",
      displayName: "GLM 5.2",
      description: "Zhipu's latest model",
      maxOutputTokens: 128_000,
      contextWindow: 131_072,
      temperature: 1.0,
      dollarSigns: 1,
    ...
    },
    {
      ...
      description: "Xiaomi's reasoning model",
    ...
    },
    {
      name: "minimax-m2.7",
      displayName: "MiniMax M2.7",
      description: "MiniMax's previous generation",
      maxOutputTokens: 128_000,
      contextWindow: 131_072,
      temperature: 1.0,
      dollarSigns: 1,
